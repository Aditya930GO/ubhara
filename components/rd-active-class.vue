    ...
    <div class="rd-class-header">
      <div class="rd-class-name-container">
        ...
        <div class="rd-class-tags-container">
          <div v-for="(classRoom, i) in data.tags" :key="i" class="rd-class-tags-box">
      ...
      <div v-if="dropDownState" class="actions-container" @focusout="dropDownCloser()">
        ...
        <div v-if="user.role !== 'student'" ripple class="action" @click="dropDownState = false">
          <div class="rd-icon-container">
...
async function submitEnrollClass() {
  console.log("submitEnrollClass begin")
  let addID: string = "";
